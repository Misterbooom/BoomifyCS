...
namespace BoomifyCS
{
    ...
    public class BifyStopIterationError : BifyException
    {
        ...
        public BifyStopIterationError(string message, string tokens, string invalidTokens, int currentLine) : base(message, tokens, invalidTokens, currentLine) { }
    }
    ...
    public class BifyArithmeticError : BifyException
    {
        ...
        public BifyArithmeticError(string message, string tokens, string invalidTokens, int currentLine) : base(message, tokens, invalidTokens, currentLine) { }
    }
    ...
    public class BifyFileNotFoundError : BifyException
    {
        ...
        public BifyFileNotFoundError(string message, string tokens, string invalidTokens, int currentLine) : base(message, tokens, invalidTokens, currentLine) { }
    }
    ...
    public class BifyPermissionError : BifyException
    {
        ...
        public BifyPermissionError(string message, string tokens, string invalidTokens, int currentLine) : base(message, tokens, invalidTokens, currentLine) { }
    }
    ...
    public class BifyConnectionError : BifyException
    {
     ...
     BifyConnectionError(string message, string tokens, string invalidTokens, int currentLine) : base(message, tokens, invalidTokens, currentLine) { }
    }
    ...
    public class BifyTimeoutExpiredError : BifyException
    {
        ...
        public BifyTimeoutExpiredError(string message, string tokens, string invalidTokens, int currentLine) : base(message, tokens, invalidTokens, currentLine) { }
    }
    ...
    public class BifyBrokenPipeError : BifyException
    {
        ...
        public BifyBrokenPipeError(string message, string tokens, string invalidTokens, int currentLine) : base(message, tokens, invalidTokens, currentLine) { }
    }
    ...
    public class BifyModuleNotFoundError : BifyException
    {
        ...
        public BifyModuleNotFoundError(string message, string tokens, string invalidTokens, int currentLine) : base(message, tokens, invalidTokens, currentLine) { }
    }
    ...
    public class BifyEOFError : BifyException
    {
        ...
        public BifyEOFError(string message, string tokens, string invalidTokens, int currentLine) : base(message, tokens, invalidTokens, currentLine) { }
    }
    ...
    public class BifySyntaxWarning : BifyException
    {
        ...
        public BifySyntaxWarning(string message, string tokens, string invalidTokens, int currentLine) : base(message, tokens, invalidTokens, currentLine) { }
    }
    ...
    public class BifyDeprecationWarning : BifyException
    {
        ...
        public BifyDeprecationWarning(string message, string tokens, string invalidTokens, int currentLine) : base(message, tokens, invalidTokens, currentLine) { }
    }
